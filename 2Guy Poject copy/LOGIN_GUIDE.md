...
1. Open the app: `http://localhost:5173` (or the port shown by Vite)
...
### Option 3: Use SQL Migration Files

If you want to automate this, add a new migration file:

```bash
# Create a new migration
touch db/migrations/002_seed_demo_users.sql
```

Then edit `db/migrations/002_seed_demo_users.sql`:
